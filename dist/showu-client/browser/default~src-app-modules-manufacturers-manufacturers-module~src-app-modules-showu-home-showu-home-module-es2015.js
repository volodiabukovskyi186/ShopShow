...
function ManufacturersSliderComponent_a_8_Template(rf, ctx) { if (rf & 1) {
...
ManufacturersSliderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ManufacturersSliderComponent, selectors: [["app-manufacturers-slider"]], viewQuery: function ManufacturersSliderComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { list: "list" }, decls: 9, vars: 1, consts: [[1, "flex", "right"], [1, "button", "transparent", "prev", 3, "click"], [1, "button", "transparent", "next", 3, "click"], [2, "overflow", "hidden", "flex-direction", "row"], [2, "width", "100%"], ["slider", ""], ["drag-scroll-item", "", "class", "ratio", 3, "routerLink", 4, "ngFor", "ngForOf"], ["drag-scroll-item", "", 1, "ratio", 3, "routerLink"], [1, "r3x1"], [1, "contain", 3, "src", "alt"]], template: function ManufacturersSliderComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var ngx_drag_scroll__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngx-drag-scroll */ "./node_modules/ngx-drag-scroll/__ivy_ngcc__/fesm2015/ngx-drag-scroll.js");
